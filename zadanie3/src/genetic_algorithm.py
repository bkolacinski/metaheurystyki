...
class GeneticAlgorithm:
    ...
    def calculate_fitness(self, population: list[list[int]], items: pd.DataFrame) -> list[float]:
        fitness_values = []
        ...
        for individual in population:
            total_weight = sum(gene * weight for gene, weight in zip(individual, weights))
    ...
    def run(self,
        ...
        for i in range(iterations):
            ...
            children = self.cross_strategy.cross(
                parents, cross_probability)
