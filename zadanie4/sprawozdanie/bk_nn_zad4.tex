...
def _update_pheromones(self, ants):
    ...
    Poniżej przedstawione wnioski są z eksperymentów dla pliku \textbf{A-n80-k10}.
    ...
    \begin{figure}[H]
        ...
        \caption{Wpływ liczby mrówek na jakość rozwiązania.}
    ...
    \begin{figure}[H]
        ...
        \caption{Wpływ prawdopodobieństwa losowego wyboru na jakość rozwiązania.}
    ...
    \begin{figure}[H]
        ...
        \caption{Wpływ współczynnika $\alpha$ na jakość rozwiązania.}
    ...
    \begin{figure}[H]
        ...
        \caption{Wpływ współczynnika $\beta$ na jakość rozwiązania.}
    ...
    \begin{figure}[H]
        ...
        \caption{Wpływ liczby iteracji na jakość rozwiązania.}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.85\textwidth]{../plots/A-n80-k10/influence_m.png}
        \caption{Wpływ współczynnika wyparowywania $\rho$ na jakość rozwiązania.}
